...
class UserManagementServiceSimple:
    ...
    def get_available_permissions(self) -> List[Dict]:
        ...
        return [
            ...
            {"name": "tax_statements.view", "description": "Visualizar informes de rendimentos"},
            {"name": "tax_statements.process", "description": "Processar informes de rendimentos"},
            {"name": "tax_statements.send", "description": "Enviar informes de rendimentos"},
