...
# Primeiro, deletar o período existente de julho/2025
print("🗑️ Deletando período Julho/2025 existente...")
...
if periods_response.status_code == 200:
    ...
    for period in periods:
        if isinstance(period, dict) and period.get('month') == 7 and period.get('year') == 2025:
            period_id = period['id']
...
WHERE pp.month = 7 AND pp.year = 2025
"""
